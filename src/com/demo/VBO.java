...
public class VBO
  ...
  VBO(FloatBuffer verticesBuffer, IntBuffer facesBuffer)
    {
    mVerticesBufferId = createFloatBuffer(GLES20.GL_ARRAY_BUFFER, verticesBuffer, GLES20.GL_STATIC_DRAW);
    mFacesBufferId = createIntBuffer(GLES20.GL_ELEMENT_ARRAY_BUFFER, facesBuffer, GLES20.GL_STATIC_DRAW);
    }
